...
import ChukayStory from "./ChukayStory";
      ...
      <Container className="text-center ">
        ...
        <Row>
          ...
          <Col md={4}>
            ...
            <h3>Resources</h3>
            <p>
              Whether you're a seasoned player, a beginner, or just a fan,
              there's a place for you at Chukay. We offer a wide range of
              resources, including articles, videos, and tips, to help you
        ...
        <div className="pb-5">
          ...
          <p className="lead pb-5">
            ...
            engaging community for our members, and we are committed to
            delivering the best possible experience for everyone who joins us.
          </p>
        </div>
      </Container>
      <ChukayStory />
